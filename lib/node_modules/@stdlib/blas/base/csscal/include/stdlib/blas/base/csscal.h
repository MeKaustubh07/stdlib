...
/**
* Header file containing function declarations for the C interface to the BLAS Level 1 routine `csscal`.
*/
#ifndef STDLIB_BLAS_BASE_CSSCAL_H
#define STDLIB_BLAS_BASE_CSSCAL_H
...
#endif // !STDLIB_BLAS_BASE_CSSCAL_H
