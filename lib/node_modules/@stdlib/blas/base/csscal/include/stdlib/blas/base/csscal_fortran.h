...
/**
* Header file containing function declarations for the Fortran interface to the BLAS Level 1 routine `csscal`.
*/
#ifndef STDLIB_BLAS_BASE_CSSCAL_FORTRAN_H
#define STDLIB_BLAS_BASE_CSSCAL_FORTRAN_H
...
*/
void csscal( const int *, const float *, void *, const int * );

#ifdef __cplusplus
}
#endif

#endif // !STDLIB_BLAS_BASE_CSSCAL_FORTRAN_H
